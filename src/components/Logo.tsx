...
export default function Logo({ className = '', hovered = false }: { className?: string; hovered?: boolean }) {
 return (
 <svg
 viewBox="0 0 40 40"
 fill="none"
 ...
 />
 {/* Heart inside bubble (Fills with currentColor when hovered) */}
 <motion.path
 ...
 strokeLinejoin="round"
 animate={{
 fill: hovered ? 'currentColor' : 'rgba(0, 0, 0, 0)',
 }}
