...
export default function ChatInterface({
 ...
 <div className="mb-6 p-4 bg-amber-50 border border-amber-200 rounded-xl max-w-md">
 ...
 <div className="shrink-0 w-8 h-8 rounded-full bg-[rgb(var(--primary))]/10 flex items-center justify-center">
 <Logo className="w-5 h-5 text-[rgb(var(--primary-hover))] " />
 </div>
 )}
 <div
 className={clsx(
 ...
 : 'bg-white/80 text-neutral-900 border border-neutral-200/50 '
 )}
 >
