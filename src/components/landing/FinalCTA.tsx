...
export default function FinalCTA() {
  ...
  return (
    <section className="relative px-4 sm:px-6 lg:px-8 py-32 sm:py-48 bg-[#FBF9F4] overflow-hidden flex items-center justify-center text-center border-t border-[#E5E0D8]">
      
      {/* Soft amber blur glow overlay */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-[#F0A955]/10 rounded-full blur-[100px] pointer-events-none" />
      ...
      >
        <motion.h2
          className="text-5xl sm:text-7xl font-bold text-neutral-900 tracking-tight mb-8 leading-tight"
          variants={{ hidden: { opacity: 0, y: 30 }, visible: { opacity: 1, y: 0, transition: { duration: 0.7 } } }}
        >
          Ready to feel a <br className="hidden sm:block" /> little lighter?
        </motion.h2>
        <motion.p
          className="text-xl sm:text-2xl text-neutral-600 font-medium max-w-2xl mx-auto mb-12"
