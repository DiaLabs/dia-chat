...
export default function Sidebar({
 ...
 className="opacity-0 group-hover:opacity-100 p-1 rounded hover:bg-neutral-200 transition-opacity cursor-pointer"
 >
 ...
 className="flex-1 flex items-center justify-center gap-2 px-3 py-2 rounded-lg text-sm text-neutral-600 hover:bg-neutral-100 transition-colors"
 >
