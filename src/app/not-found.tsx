...
export default function NotFound() {
 ...
 className="mb-6"
 >
 <div className="text-8xl font-bold text-neutral-200 mb-2">
 404
 </div>
 ...
 <Link
 href="/chat"
 className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-full bg-neutral-100 hover:bg-neutral-200 text-neutral-900 font-semibold transition-all hover:scale-105"
 >
